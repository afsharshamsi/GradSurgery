    ...
    def forward(self, x, iter_, targets=None, flag=True, group=None):
        ...
        if targets is None:
            for _ in range(self.steps):
                if flag:
                    outputs, backward, final_backward = forward_and_adapt_deyo(x, iter_, self.model,
...
def forward_and_adapt_deyo(x, iter_, model, optimizer, deyo_margin, margin, targets=None, flag=True, group=None):
